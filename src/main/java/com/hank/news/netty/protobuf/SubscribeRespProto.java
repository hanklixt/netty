...
public final class SubscribeRespProto {
  ...
  public interface SubscribeRespOrBuilder
    ...
    // required string subRespCode = 2;
    /**
     * <code>required string subRespCode = 2;</code>
     */
    boolean hasSubRespCode();
    /**
     * <code>required string subRespCode = 2;</code>
     */
    String getSubRespCode();
    /**
     * <code>required string subRespCode = 2;</code>
     */
  ...
  public static final class SubscribeResp extends
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000002) == 0x00000002)) {
        output.writeBytes(2, getSubRespCodeBytes());
      }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000002) == 0x00000002)) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(2, getSubRespCodeBytes());
      }
      if (((bitField0_ & 0x00000004) == 0x00000004)) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public static final class Builder extends
      ...
      // Construct using com.hank.news.netty.protobuf.SubscribeRespProto.SubscribeResp.newBuilder()
      private Builder() {
      ...
      public Builder mergeFrom(SubscribeResp other) {
        ...
        if (other.hasSubRespCode()) {
          bitField0_ |= 0x00000002;
          subRespCode_ = other.subRespCode_;
          onChanged();
        }
        if (other.hasDesc()) {
          bitField0_ |= 0x00000004;
  ...
  bitField0_ |= 0x00000002;
      ...
      public Builder clearSubRespCode() {
        bitField0_ = (bitField0_ & ~0x00000002);
        subRespCode_ = getDefaultInstance().getSubRespCode();
        onChanged();
        return this;
      }
      /**
       * <code>required string subRespCode = 2;</code>
       */
      public Builder setSubRespCodeBytes(
  ...
  static {
    String[] descriptorData = {
      ...
      " \002(\t\022\014\n\004desc\030\003 \002(\tB2\n\034com.hank.news.nett" +
      "y.protobufB\022SubscribeRespProto"
    };
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_netty_SubscribeResp_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_netty_SubscribeResp_descriptor,
              new String[] { "SubReqId", "SubRespCode", "Desc", });
          return null;
        }
      };
